  ...
  return (
    <div className="loader-container flex flex-col gap-8">
      ...
      <div className="loader-4 flex gap-1">
        <div className="block block-1 w-10 h-4 bg-rose-300 relative rounded" />
        <div className="block block-2 w-10 h-4 bg-rose-400 relative rounded" />
        <div className="block block-3 w-10 h-4 bg-rose-500 relative rounded" />
        <div className="block block-4 w-10 h-4 bg-rose-600 relative rounded" />
        <div className="block block-5 w-10 h-4 bg-rose-700 relative rounded" />
      </div>
      {/* loader - 3 - end */}
    </div>
  );
